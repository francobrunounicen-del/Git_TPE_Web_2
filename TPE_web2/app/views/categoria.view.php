...
class CategoriaView {
    ...
    public function showFormCategoria(){
        require_once __DIR__ . '/../../templates/layout/header.php';
        require_once __DIR__ . '/../../templates/form_categoria.phtml';
        require_once __DIR__ . '/../../templates/layout/footer.php';
    }
    ...
    public function showEditFormCategoria($id){
        ...
        if(!$categoria){
            return $this->errorView->renderError("Categoria no encontrada");
        }
    ...
    public function renderEditFormCategoria($categoria){
        require_once __DIR__ . '/../../templates/layout/header.php';
        require_once __DIR__ . '/../../templates/form_edit_categoria.phtml';
        require_once __DIR__ . '/../../templates/layout/footer.php';
    }
}